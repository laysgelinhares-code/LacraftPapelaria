...
const TODAY = (() => { const t = new Date(); const p = (x) => String(x).padStart(2, '0'); return `${t.getFullYear()}-${p(t.getMonth() + 1)}-${p(t.getDate())}`; })();
const todayISO = () => TODAY;
const plusDaysISO = (n) => { const t = new Date(Date.now() + n * 86400000); const p = (x) => String(x).padStart(2, '0'); return `${t.getFullYear()}-${p(t.getMonth() + 1)}-${p(t.getDate())}`; };
const yearNow = 2026;
